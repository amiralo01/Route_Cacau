...
export class LocalidadeRotaController {
  ...
  async find(
    ...
    return this.localidadeRepository.localidadeFinal(id).find(filter);
  }
      ...
      content: {
        'application/json': {
          schema: getModelSchemaRef(Rota, {
            ...
            exclude: ['idRota'],
            optional: ['localidadeFinal']
          }),
        },
      },
    }) rota: Omit<Rota, 'idRota'>,
  ): Promise<Rota> {
    return this.localidadeRepository.localidadeFinal(id).create(rota);
  }
  ...
  async patch(
    ...
    return this.localidadeRepository.localidadeFinal(id).patch(rota, where);
  }
  ...
  async delete(
    ...
    return this.localidadeRepository.localidadeFinal(id).delete(where);
  }
}
